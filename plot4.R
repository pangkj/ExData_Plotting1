...
legend("topright", lty=1,bty="n",cex=0.5, xjust=0, col = c("black","red","blue"), legend = c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"))
with(PowerData, plot(DT, Voltage, type="l", xlab="datetime", ylab="Voltage"))
with(PowerData, plot(DT, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
